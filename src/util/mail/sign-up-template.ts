  ...
  * {
  ...
  <table id="u_content_heading_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <!--[if mso]><table width="100%"><tr><td><![endif]-->
      <h1 class="v-text-align v-font-size" style="margin: 0px; color: #023047; line-height: 170%; text-align: center; word-wrap: break-word; font-family: 'Open Sans',sans-serif; font-size: 26px; font-weight: 400;"><span><strong>KÜTÜPHANEYE HOŞGELDİN</strong></span></h1>
  ...
  <table id="u_content_text_2" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align v-font-size" style="font-size: 14px; color: #333333; line-height: 180%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 180%;"><span style="font-size: 18px; line-height: 32.4px; font-family: Lato, sans-serif;"><strong><span style="line-height: 32.4px; font-size: 18px;">Selam  ${user_name}, </span></strong></span></p>
  <p style="font-size: 14px; line-height: 180%;"> </p>
  <p style="font-size: 14px; line-height: 180%;"><span style="font-family: Lato, sans-serif; font-size: 16px; line-height: 28.8px;">Kütüphane sitesine üyeliğini doğrulamak için altta bulunan butona basman lazım. Bu sitenin genel amacı okuduğum veya yarım bıraktığım kitapların bir yandan log bilgilerini tutarken bir yandan kendime back-end konusunda bilgi kazanırmaktı. Herkes gibi gidip todo uygulaması yapmak bana pek bir şey katmaz diye düşündüm. Belki biraz over engineering yapmış olabilirim bunun farkındayım ancak bana çok faydası dokundu. :)</span></p>
  <p style="font-size: 14px; line-height: 180%;"> </p>
  <p style="font-size: 14px; line-height: 180%;"><span style="font-size: 16px; line-height: 28.8px; font-family: Lato, sans-serif;"><strong><span style="line-height: 28.8px; font-size: 16px;">Üyeliğin onaylandıktan sonra aşağıda gözüken birkaç şeyi yapamıyor olabilirsin. Bunun sebebi site herkese açık olduğundan kitapların veya yazar kısımlarında kötü söz bulundurmamak:</span></strong></span></p>
  <ul style="list-style-type: square;">
  <li style="font-size: 14px; line-height: 28.8px;"><span style="font-family: Lato, sans-serif; font-size: 16px; line-height: 28.8px;"><strong>Herhangi bir güncelleme silme veya ekleme özelliği</strong></span></li>
  <li style="font-size: 14px; line-height: 28.8px;"><span style="font-family: Lato, sans-serif; font-size: 16px; line-height: 28.8px;"><strong>Gizlilik ayarlarını güncelleyememek</strong></span></li>
  <li style="font-size: 14px; line-height: 28.8px;"><span style="font-family: Lato, sans-serif; font-size: 16px; line-height: 28.8px;"><strong>Kitapları kendi kitaplığına ekleyememek.</strong></span></li>
  </ul>
    </div>
  ...
  <div class="v-text-align" align="center">
    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://unlayer.com" style="height:57px; v-text-anchor:middle; width:270px;" arcsize="77%"  stroke="f" fillcolor="#33428d"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
      <a href="${link}" target="_blank" class="v-button v-font-size" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #33428d; border-radius: 44px;-webkit-border-radius: 44px; -moz-border-radius: 44px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
        <span style="display:block;padding:20px 70px;line-height:120%;"><strong><span style="font-family: 'Open Sans', sans-serif; font-size: 14px; line-height: 16.8px;">HESABIMI ONAYLA</span></strong></span>
      </a>
  ...
  <table id="u_content_text_3" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align v-font-size" style="font-size: 14px; line-height: 170%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 170%;"><span style="font-family: Lato, sans-serif; font-size: 16px; line-height: 27.2px;">Yapamama sebebini söylediğime göre bunları yapabilmek için yetki verebilirim ve bir kullanıcı yetki aldıktan sonra bunları yapabilecek bir düzeye gelebilir. Ancak tabikide dediğim gibi bu site sadece yeteneklerimi arttırmak ve görmek.</span></p>
  <p style="font-size: 14px; line-height: 170%;"> </p>
  <p style="font-size: 14px; line-height: 170%;"><span style="font-family: Lato, sans-serif; font-size: 16px; line-height: 27.2px;">Eğer herhangi bir sorun olursa bana linkedIn üzerinden ulaşabilirsin. </span></p>
  <p style="font-size: 14px; line-height: 170%;"> </p>
  <p style="font-size: 14px; line-height: 170%;"><span style="font-family: Lato, sans-serif; font-size: 16px; line-height: 27.2px;">Saygılarımla</span></p>
  <p style="font-size: 14px; line-height: 170%;"><span style="font-family: Lato, sans-serif; font-size: 14px; line-height: 23.8px;"><strong><span style="font-size: 16px; line-height: 27.2px;">Atalay Karahan</span></strong></span></p>
    </div>
  ...
  <div align="center">
    ...
    <!--[if (mso)|(IE)]><table width="134" cellpadding="0" cellspacing="0" border="0"><tr><td style="border-collapse:collapse;" align="center"><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse; mso-table-lspace: 0pt;mso-table-rspace: 0pt; width:134px;"><tr><![endif]-->
  ...
  <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align v-font-size" style="font-size: 14px; color: #ffffff; line-height: 210%; text-align: center; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 210%;"><span style="font-family: Lato, sans-serif; font-size: 14px; line-height: 29.4px;">atalaykarahan.com üzerinden üye olma işlemi gerçekleştirdiğin için bu e-postayı alıyorsunuz.</span></p>
    </div>
